...
contract PriceOracle {
    ...
    /**
      ...
      */
    function getUnderlyingPrice(MarketToken cToken) external view returns (uint);
}
...
contract PlanetDiscount is Exponential,Ownable{
    ...
    function returnDiscountPercentage(address borrower) external view returns(uint discount){
        ...
        MarketToken[] memory userInMarkets = ComptrollerInterface(comptroller).getAssetsIn(borrower);
...
contract CTokenSupplyDiscount {
     ...
     */
     event SupplyDiscountAccrued(address supplier,uint discountGiven,uint lastUpdated);
}


// File: PlanetLending/CErc20Delegator.sol
 ...
 * @author Compound
 */
contract CErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface, CTokenSupplyDiscount {
    /**
